...
const EquipmentCard = () => {
  return (
    <div className="flex flex-col rounded-[24px] bg-[#51A594] p-[20px] items-center justify-between max-w-[280px] w-full min-h-[400px]">
      <div className="flex flex-col items-center">
        <h3 className="font-semibold text-[24px] text-white pb-[20px]">
          Хирургия
        </h3>
        <div className="bg-[#3D8072] rounded-[20px] max-w-[190px] w-full">
