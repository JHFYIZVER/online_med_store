...
const Header = () => {
  ...
  return (
    <>
      <header>
        <div className="header-upper flex items-center justify-between px-[40px] py-[20px] h-[100px]">
          <Logo />
        ...
        <div className="header-bar flex items-center justify-between px-[40px] py-[20px] h-[100px] bg-[#6EAF7E] text-white text-[20px]">
